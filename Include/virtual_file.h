...
public:
	...
	virtual const HTTPResponse* GetFromPath(dynamic_string host, const char* pFullPath, const char* pPartialPath, SOCKET s) const = 0;
...
public:
	...
	virtual const HTTPResponse* GetFromPath(dynamic_string host, const char* pFullPath, const char* pPartialPath, SOCKET s) const;
