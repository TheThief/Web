...
public:
	...
	virtual dynamic_ptr<HTTPResponse> GetFromPath(dynamic_string method, dynamic_string host, const char* pFullPath, const char* pPartialPath, SOCKET s) const = 0;
...
public:
	...
	virtual dynamic_ptr<HTTPResponse> GetFromPath(dynamic_string method, dynamic_string host, const char* pFullPath, const char* pPartialPath, SOCKET s) const;
